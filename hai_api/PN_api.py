...
@MODULES.register()
class ParNet(AbstractModule):
    name = 'ParticleNet'  # Specify the name of your model explicitly
    description = '2020 SOTA Jet tagging algorithm'  # Specify the description of your model
