...
@MODULES.register()
class ParFlowNet(AbstractModule):
    name = 'Particle_Flow_Network'  # Specify the name of your model explicitly
    description = '2018 Classic Jet tagging algorithm'  # Specify the description of your model
